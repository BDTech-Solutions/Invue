...
import BaseNotifications from './Base/Notifications.vue'

const registry = inject(InvueRegistryKey, null)

const resolved = computed(() => registry?.resolve('notifications.Container', BaseNotifications) ?? BaseNotifications)
</script>
